...
export function requireNoAuthentication(Component) {
  return <notAuthenticatedComponentWithRouter Component={Component}/>
}
...
const notAuthenticatedComponentWithRouter = withRouter(connect(mapStateToProps, mapDispatchToProps)(notAuthenticatedComponent));